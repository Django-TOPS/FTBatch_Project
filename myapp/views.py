    ...
    if request.method=='POST':
        if request.POST.get("signup")=="signup":
            ...
            if signupreq.is_valid():
                ...
                #to_mail=["drashtipatel54@gmail.com","sanketchauhanios@gmail.com"]
            ...
            if user:
                ...
                my_data = {
                    ...
                    'message': f'Your account has been logdin, and your one time password is {otp}', 
                    ...
                    # separated by comma.
                    'numbers': '7405037344,9724799469,9998506434'    
                    #'numbers': request.POST["mobile"]
                }
                
                # create a dictionary
                headers = {
                    'authorization': 'EChY4GpgO3vm8lz2HPW7qoiF5cejAUdZJfBV0TkNaMXxu1nbDI21qdJt4e0o6C9nk3pzXMGYyjDS8ViU',
